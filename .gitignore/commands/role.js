...
module.exports = class Role extends Command {
	...
	static action(message) {
		...
		if (message.content.startsWith(prefix + 'role -dev')) {
		...
		} else if(message.content.startsWith(prefix + 'role -Débile')) {

			message.member.addRole(message.member.guild.roles.find('name', 'Débile'));

			var embed = new Discord.RichEmbed()
			.setColor("#226666")
			.addField("Role Hacker", "Role Débile ajouté avec succès")
			message.channel.send(embed)
			...
			var embed = new Discord.RichEmbed()
			.setColor("#226666")
			.addField("Role Front-end", "Role Gentil ajouté avec succès")
			message.channel.send(embed)
			...
			var embed = new Discord.RichEmbed()
			.setColor("#226666")
			.addField("Role Back-end", "Role Roux ajouté avec succès")
			message.channel.send(embed)
			...
			var embed = new Discord.RichEmbed()
			.setColor("#226666")
			.addField("Role Full-stack", "Role Français ajouté avec succès")
			message.channel.send(embed)
		...
		if (message.content.startsWith('!krole --dev')) {
			...
			var embed = new Discord.RichEmbed()
			.setColor("#226666")
			.addField("Role Hacker", "Role Débile retiré avec succès")
			message.channel.send(embed)
			...
			var embed = new Discord.RichEmbed()
			.setColor("#226666")
			.addField("Role Journaliste", "Role Roux retiré avec succès")
			message.channel.send(embed)
			...
			var embed = new Discord.RichEmbed()
			.setColor("#226666")
			.addField("Role Front-end", "Role Français retiré avec succès")
			message.channel.send(embed)
			...
			var embed = new Discord.RichEmbed()
			.setColor("#226666")
			.addField("Role Back-end", "Gentil-end retiré avec succès")
			message.channel.send(embed)
		}
